                            ...
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                ...
                                <ol class="carousel-indicators">
                                	...
                                	<%if(i>=4) break; //총 4개까지만!%>
										<li <%if(i==0) {%> class="actvie" <%}%> data-target="#product_details_slider" data-slide-to="<%=i %>" style="background-image: url(/resources/data/addon/<%=image.getImage_id()%>.<%=image.getFilename()%>);">
									<%} %>
                                </ol>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                           ...
                           <%--  <!--1~5사이의 값에 따라 조건을 부여하고, 미달점수의 경우 -o를 붙인다  -->
                            ...
                            <!-- Add to Cart Form -->
                            <form class="cart clearfix mb-50 d-flex" id="cart_form">
