...
<script>
	$(function(){
		$(".product-quicview").on("click", function (e) {
			//지금 클릭한 상품의 정보를 구해와서, 퀵뷰창에 보여줘야한다!!
								...
								<div class="menu-list">
									<ul id="menu-content2" class="menu-content collapse out">
										...
										<li data-toggle="collapse"
											data-target="#<%="sub" + topCategory.getTopcategory_id()%>"
											class="collapsed"><a href="#"><%=topCategory.getName()%><span
												class="arrow"></span></a>
											<ul class="sub-menu collapse"
												id="<%="sub" + topCategory.getTopcategory_id()%>">
												<%
						...
						<div class="row">
							...
							<div
								...
								<div class="product-img">
									<img
										src="/resources/data/basic/<%=product.getProduct_id()%>.<%=product.getFilename()%>"
										alt="">
