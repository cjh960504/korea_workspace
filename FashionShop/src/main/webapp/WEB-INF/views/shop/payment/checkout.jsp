...
<head>
	...
	function setData(ch) {
		...
		if(ch.checked){//체크를 했다면, 주문자 정보를 수령인 정보에 대입
                        ...
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form id="checkout-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="receive_name">받으실분 이름<span>*</span></label>
                                        <input type="text" class="form-control" id="receive_name" name="receiver_name" value="" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="receive_name">연락처 <span>*</span></label>
                                        <input type="text" class="form-control" id="receive_phone" name="receiver_phone" value="" required>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <label for="receive_addr">받으실 주소</label>
                                        <input type="text" class="form-control" id="receive_addr" name="receiver_addr" value="">
                                    </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-5 ml-lg-auto">
                        <div class="order-details-confirmation">
                            ...
                            <ul class="order-details-form mb-4">
                                ...
                                <li><span>청바지외 2건</span> <span><%=Formatter.getCurrency(totalPrice) %></span></li>
                                <li><span>할인쿠폰</span> <span>0</span></li>
                                <li><span>최종 결제하실 금액</span> <span><%=Formatter.getCurrency(totalPrice) %></span></li>
                            </ul>
