			...
			<ul id="menu-content" class="menu-content collapse out">
				   ...
				   <%TopCategory topCategory = topList.get(i); %>
	                    <li data-toggle="collapse" data-target="#<%=topCategory.getTopcategory_id()%>" class="collapsed active">
	                        ...
	                        <%for(int j=0;j<topCategory.getSubCategoryList().size();j++){ %>
	                        <%SubCategory subCategory =  topCategory.getSubCategoryList().get(j);%>
				...
				<div class="row h-100 align-items-center justify-content-end">
					...
					<div class="col-12 col-lg-7">
						<div class="top_single_area d-flex align-items-center">
							<!-- Logo Area -->
							<div class="top_logo">
								<a href="#"><img src="/resources/img/core-img/logo.png"
									alt=""></a>
							</div>
							<!-- Cart & Menu Area -->
								...
								<div class="cart">
									...
									<ul class="cart-list">
										<li><a href="#" class="image"><img
												src="/resources/img/product-img/product-10.jpg"
										...
										<li><a href="#" class="image"><img
												src="/resources/img/product-img/product-11.jpg"
												class="cart-thumb" alt=""></a>
											<div class="cart-item-desc">
												<h6>
													<a href="#">Women's Fashion</a>
										...
										<li class="total"><span class="pull-right">Total:
												$20.00</span> <a href="cart.html" class="btn btn-sm btn-cart">Cart</a>
				...
				<div class="row h-100">
					<div class="col-12 d-md-flex justify-content-between">
						...
						<div class="header-social-area">
							<a href="#"><span class="karl-level">Share</span> <i
						...
						<!-- Help Line -->
						<div class="help-line">
							<a href="tel:+346573556778"><i class="ti-headphone-alt"></i>
								+34 657 3556 778</a>
						</div>
					</div>
				</div>
